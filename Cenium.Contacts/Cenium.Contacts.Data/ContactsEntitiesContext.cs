...
namespace Cenium.Contacts.Data
{
    ...
    public partial class ContactsEntitiesContext : EntityContext, IDisposable
    {
        ...
        /// <summary>
        /// Returns a typed EntityCollection of ReservationContact that is used to perform create, read, update, delete (CRUD) operations.
        /// </summary>
        public virtual EntityCollection<ReservationContact> ReservationContacts
        {
            get { return GetEntityCollection<ReservationContact>(); }
        }
