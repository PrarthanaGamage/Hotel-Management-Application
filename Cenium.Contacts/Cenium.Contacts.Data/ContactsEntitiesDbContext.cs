...
namespace Cenium.Contacts.Data
{
    ...
    public partial class ContactsEntitiesDbContext : DbContextBase, IDisposable
    {
        ...
        /// <summary>
        /// Returns a typed entity set of ReservationContact that is used to perform create, read, update, delete (CRUD) operations.
        /// </summary>
        public virtual DbSet<ReservationContact> ReservationContacts
        {
            get;
            set;
        }
        ...
        protected override void Configure(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Contact>().Property(p => p.DoB).HasColumnType("date");
        }
