 ...
 * User        Date          Comment
 * ----------- ------------- --------------------------------------------------------------------------------------------
 * Prarthana.G 02/17/2022    Created
 */
...
namespace Cenium.Reservations.Client.Windows
{
	...
	public class ReservationsClientInitializer : IInitializer
    {
        ...
        public void Initialize()
        {
            ...
            IconManager.Register("Reservations.icon.testicon", string.Format(IconPath, "testicon"));

            IconManager.Register("Reservations.icon.CheckIn", string.Format(IconPath, "CheckIn"));
