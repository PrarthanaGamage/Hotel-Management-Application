...
namespace Cenium.Rooms.Data
{
    ...
    public partial class RoomsEntitiesContext : EntityContext, IDisposable
    {
        ...
        /// <summary>
        /// Returns a typed EntityCollection of RoomFeature that is used to perform create, read, update, delete (CRUD) operations.
        /// </summary>
        public virtual EntityCollection<RoomFeature> RoomFeatures
        {
            get { return GetEntityCollection<RoomFeature>(); }
        }
