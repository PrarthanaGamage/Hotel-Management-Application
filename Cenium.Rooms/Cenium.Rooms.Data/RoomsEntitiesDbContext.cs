...
namespace Cenium.Rooms.Data
{
    ...
    public partial class RoomsEntitiesDbContext : DbContextBase, IDisposable
    {
        ...
        /// <summary>
        /// Returns a typed entity set of RoomFeature that is used to perform create, read, update, delete (CRUD) operations.
        /// </summary>
        public virtual DbSet<RoomFeature> RoomFeatures
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Setup additional configurations for the context
        /// </summary>
        ...
        protected override void Configure(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Room>().Property(p => p.ReservedFrom).HasColumnType("date");
            modelBuilder.Entity<Room>().Property(p => p.ReservedTill).HasColumnType("date");
        }
